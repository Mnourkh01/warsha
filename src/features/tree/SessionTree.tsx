  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-header">
        ...
        <button className="icon-btn" title="New workspace" onClick={() => newWorkspace()}>
          <FolderPlus size={16} />
        </button>
        ...
        {!editing && (
          <span className="row-actions" onClick={(e) => e.stopPropagation()}>
            <button
              ...
              title={full ? "Workspace full (6)" : "New session here"}
              disabled={full}
              onClick={() => {
            ...
            <button className="icon-btn sm" title="Delete workspace" onClick={() => deleteWorkspace(ws.id)}>
              <Trash2 size={13} />
            </button>
          </span>
        )}
    ...
    >
      ...
      {!editing && (
        <span className="row-actions" onClick={(e) => e.stopPropagation()}>
          ...
          <button className="icon-btn sm" title="Close session" onClick={() => closeSession(id)}>
            <X size={13} />
          </button>
        </span>
      )}
